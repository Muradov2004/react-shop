...
import {deleteAllItemsFromOrderFetch, sendOrderFetch} from "../../store/fetchs";
import Map from '../Map';
...
const OrderForm = ({orders, openNotification}) => {
  ...
  const onFinish = (values) => {
    ...
    dispatch(deleteAllItemsFromOrderFetch());
    form.resetFields();
    setMapCoordinates({latitude: null, longitude: null});
  };
